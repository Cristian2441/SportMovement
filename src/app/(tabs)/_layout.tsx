/**
 * Tabs Layout — Sport Movement
 *
 * Bottom tab bar rosa con 4 pestañas:
 *   agenda · reservar · progreso · tienda
 */
...
export default function TabLayout() {
  ...
  const tabHeight = (Platform.OS === 'ios' ? 86 : 68) + (Platform.OS === 'android' ? insets.bottom : 0);
    ...
    >
      ...
      <Tabs.Screen
        ...
        options={{
          title: 'reservar',
          tabBarIcon: ({ color }) => (
            <TabIcon name="dumbbell" color={color} />
          ),
        }}
      />
